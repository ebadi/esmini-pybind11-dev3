...
MYMODULE=playerbase
rm -rf $PWD/src/$MYMODULE ;  mkdir  $PWD/src/$MYMODULE
/home/wave/binder/bin/binder --root-module py$MYMODULE --prefix $PWD/src/$MYMODULE --bind $MYMODULE  --single-file  --config $MYMODULE.cfg  $PWD/src/esmini$MYMODULE.hpp  -- -std=c++11 -DNDEBUG $IPATHS
pip3 install . ;
