...
# /home/wave/binder/bin/binder --root-module py$MYMODULE --prefix $PWD/src/$MYMODULE --bind $MYMODULE  --single-file --suppress-errors  --config $MYMODULE.cfg  $PWD/src/$MYMODULE.hpp  -- -std=c++11 -DNDEBUG $IPATHS
# pip3 install . ;
