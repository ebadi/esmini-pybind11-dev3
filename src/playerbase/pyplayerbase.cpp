...
// scenarioengine::BaseSensor file: line:32
struct PyCallBack_scenarioengine_BaseSensor : public scenarioengine::BaseSensor {
	using scenarioengine::BaseSensor::BaseSensor;

	void Update() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const scenarioengine::BaseSensor *>(this), "Update");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
		...
		return BaseSensor::Update();
	}
};

// scenarioengine::ObjectSensor file: line:52
struct PyCallBack_scenarioengine_ObjectSensor : public scenarioengine::ObjectSensor {
	using scenarioengine::ObjectSensor::ObjectSensor;

	void Update() override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const scenarioengine::ObjectSensor *>(this), "Update");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>();
			if (pybind11::detail::cast_is_temporary_value_reference<void>::value) {
				static pybind11::detail::override_caster_t<void> caster;
...
void bind_unknown_unknown_9(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// scenarioengine::StartServer(class scenarioengine::ScenarioEngine *) file: line:41
	M("scenarioengine").def("StartServer", (void (*)(class scenarioengine::ScenarioEngine *)) &scenarioengine::StartServer, "C++: scenarioengine::StartServer(class scenarioengine::ScenarioEngine *) --> void", pybind11::arg("scenarioEngine"));

	// scenarioengine::StopServer() file: line:42
	M("scenarioengine").def("StopServer", (void (*)()) &scenarioengine::StopServer, "C++: scenarioengine::StopServer() --> void");

	{ // scenarioengine::BaseSensor file: line:32
		pybind11::class_<scenarioengine::BaseSensor, std::shared_ptr<scenarioengine::BaseSensor>, PyCallBack_scenarioengine_BaseSensor> cl(M("scenarioengine"), "BaseSensor", "");
		cl.def( pybind11::init<scenarioengine::BaseSensor::Type, double, double, double, double>(), pybind11::arg("type"), pybind11::arg("pos_x"), pybind11::arg("pos_y"), pybind11::arg("pos_z"), pybind11::arg("heading") );

		cl.def_readwrite("type_", &scenarioengine::BaseSensor::type_);
		cl.def("Update", (void (scenarioengine::BaseSensor::*)()) &scenarioengine::BaseSensor::Update, "C++: scenarioengine::BaseSensor::Update() --> void");
		cl.def("assign", (class scenarioengine::BaseSensor & (scenarioengine::BaseSensor::*)(const class scenarioengine::BaseSensor &)) &scenarioengine::BaseSensor::operator=, "C++: scenarioengine::BaseSensor::operator=(const class scenarioengine::BaseSensor &) --> class scenarioengine::BaseSensor &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	}
	{ // scenarioengine::ObjectSensor file: line:52
		pybind11::class_<scenarioengine::ObjectSensor, std::shared_ptr<scenarioengine::ObjectSensor>, PyCallBack_scenarioengine_ObjectSensor, scenarioengine::BaseSensor> cl(M("scenarioengine"), "ObjectSensor", "");
		cl.def( pybind11::init<class scenarioengine::Entities *, class scenarioengine::Object *, double, double, double, double, double, double, double, int>(), pybind11::arg("entities"), pybind11::arg("refobj"), pybind11::arg("pos_x"), pybind11::arg("pos_y"), pybind11::arg("pos_z"), pybind11::arg("heading"), pybind11::arg("nearClip"), pybind11::arg("farClip"), pybind11::arg("fovH"), pybind11::arg("maxObj") );

		cl.def_readwrite("near_", &scenarioengine::ObjectSensor::near_);
		cl.def_readwrite("near_sq_", &scenarioengine::ObjectSensor::near_sq_);
		cl.def_readwrite("far_", &scenarioengine::ObjectSensor::far_);
		cl.def_readwrite("far_sq_", &scenarioengine::ObjectSensor::far_sq_);
		cl.def_readwrite("fovH_", &scenarioengine::ObjectSensor::fovH_);
		cl.def_readwrite("fovV_", &scenarioengine::ObjectSensor::fovV_);
		cl.def_readwrite("maxObj_", &scenarioengine::ObjectSensor::maxObj_);
		cl.def_readwrite("nObj_", &scenarioengine::ObjectSensor::nObj_);
		cl.def("Update", (void (scenarioengine::ObjectSensor::*)()) &scenarioengine::ObjectSensor::Update, "C++: scenarioengine::ObjectSensor::Update() --> void");
		cl.def("assign", (class scenarioengine::ObjectSensor & (scenarioengine::ObjectSensor::*)(const class scenarioengine::ObjectSensor &)) &scenarioengine::ObjectSensor::operator=, "C++: scenarioengine::ObjectSensor::operator=(const class scenarioengine::ObjectSensor &) --> class scenarioengine::ObjectSensor &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	}
}
...
// Source list file: /home/wave/repositories/esmini-pybind11/src/playerbase/pyplayerbase.sources
// pyplayerbase.cpp
// unknown/unknown.cpp
...
// Modules list file: /home/wave/repositories/esmini-pybind11/src/playerbase/pyplayerbase.modules
// scenarioengine 
