...
void bind_unknown_unknown(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// SE_Init(const char *, int, int, int, int) file: line:134
	...
	// SE_InitWithString(const char *, int, int, int, int) file: line:145
	...
	// SE_GetSceneGraphFilename() file: line:201
	...
	// SE_GetODRManager() file: line:217
	M("").def("SE_GetODRManager", (void * (*)()) &SE_GetODRManager, "C++: SE_GetODRManager() --> void *", pybind11::return_value_policy::automatic);

	// SE_ReportObjectPos(int, float, float, float, float, float, float, float, float) file: line:233
	...
	// SE_ReportObjectPosXYH(int, float, float, float, float, float) file: line:246
	...
	// SE_ReportObjectRoadPos(int, float, int, int, float, float, float) file: line:259
	...
	// SE_ReportObjectSpeed(int, float) file: line:267
	...
	// SE_ReportObjectLateralPosition(int, float) file: line:275
	...
	// SE_ReportObjectLateralLanePosition(int, int, float) file: line:284
	...
	// SE_GetNumberOfObjects() file: line:290
	...
	// SE_GetObjectName(int) file: line:305
	...
	// SE_ObjectHasGhost(int) file: line:312
	...
	// SE_AddObjectSensor(int, float, float, float, float, float, float, float, int) file: line:355
	...
	// SE_FetchSensorObjectList(int, int *) file: line:363
	...
	// SE_GetNumberOfRoadSigns(int) file: line:380
	...
	// SE_OpenOSISocket(const char *) file: line:397
	...
	// SE_UpdateOSIGroundTruth() file: line:413
	M("").def("SE_UpdateOSIGroundTruth", (int (*)()) &SE_UpdateOSIGroundTruth, "	The SE_UpdateOSIGroundTruth function returns a char array containing the osi GroundTruth serialized to a string\n\nC++: SE_UpdateOSIGroundTruth() --> int");

	// SE_GetOSIGroundTruth(int *) file: line:418
	...
	// SE_GetOSIGroundTruthRaw() file: line:424
	...
	// SE_GetOSIRoadLane(int *, int) file: line:429
	...
	// SE_GetOSILaneBoundary(int *, int) file: line:434
	...
	// SE_GetOSISensorDataRaw() file: line:447
	...
	// SE_OSIFileOpen(const char *) file: line:452
	...
	// SE_OSIFileWrite(bool) file: line:457
	...
	// SE_SimpleVehicleCreate(float, float, float, float) file: line:478
	...
	// SE_SimpleVehicleDelete(void *) file: line:483
	...
	// SE_SimpleVehicleControlBinary(void *, double, int, int) file: line:492
...
{
	// SE_SimpleVehicleControlAnalog(void *, double, double, double) file: line:501
	...
	// SE_SimpleVehicleSetMaxSpeed(void *, float) file: line:507
